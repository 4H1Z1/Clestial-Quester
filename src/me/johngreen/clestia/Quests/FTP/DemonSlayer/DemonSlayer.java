package me.johngreen.clestia.Quests.FTP.DemonSlayer;
 ...
 */
public class DemonSlayer extends QuestBase {

    public DemonSlayer(ClientContext ctx,Clestia clestia){
        super(51, Quests.DEMON_SLAYER,"Demon Slayer",ctx,clestia);
    }
