package me.johngreen.clestia.Quests.FTP.DragonSlayer;
 ...
 */
public class DragonSlayer extends QuestBase {

    public DragonSlayer(ClientContext ctx,Clestia clestia){
        super(66, Quests.DRAGON_SLAYER,"Dragon Slayer",ctx,clestia);
    }
