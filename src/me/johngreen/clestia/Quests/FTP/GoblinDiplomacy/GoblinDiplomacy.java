package me.johngreen.clestia.Quests.FTP.GoblinDiplomacy;
 ...
 */
public class GoblinDiplomacy extends QuestBase {

    public GoblinDiplomacy(ClientContext ctx,Clestia clestia){
        super(137, Quests.GOBLIN_DIPLOMACY,"Goblin Diplomacy",ctx,clestia);
    }
