package me.johngreen.clestia.Quests.FTP.GunnarsGround;
 ...
 */
public class GunnarsGround extends QuestBase {

    public GunnarsGround(ClientContext ctx,Clestia clestia){
        super(179, Quests.GUNNARS_GROUND,"Gunnars Ground",ctx,clestia);
    }
