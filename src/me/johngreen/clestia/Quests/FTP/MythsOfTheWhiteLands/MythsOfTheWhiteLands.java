package me.johngreen.clestia.Quests.FTP.MythsOfTheWhiteLands;
 ...
 */
public class MythsOfTheWhiteLands extends QuestBase {

    public MythsOfTheWhiteLands(ClientContext ctx,Clestia clestia){
        super(74, Quests.MYTHS_OF_THE_WHITE_LANDS,"Myths Of The White Lands",ctx,clestia);
    }
