package me.johngreen.clestia.Quests.FTP.PiratesTreasure;
 ...
 */
public class PiratesTreasure extends QuestBase {

    public PiratesTreasure(ClientContext ctx,Clestia clestia){
        super(60, Quests.PIRATES_TREASURE,"Pirates Treasure",ctx,clestia);
    }
