package me.johngreen.clestia.Quests.FTP.RuneMysteries;
 ...
 */
public class RuneMysteries extends QuestBase {

    public RuneMysteries(ClientContext ctx,Clestia clestia){
        super(55, Quests.RUNE_MYSTERIES,"Rune Mysteries",ctx,clestia);
    }
