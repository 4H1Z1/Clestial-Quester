package me.johngreen.clestia.Quests.FTP.SweptAway;
 ...
 */
public class SweptAway extends QuestBase {

    public SweptAway(ClientContext ctx,Clestia clestia){
        super(20, Quests.SWEPT_AWAY,"Swept Away",ctx,clestia);
    }
