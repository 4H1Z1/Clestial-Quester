package me.johngreen.clestia.Quests.FTP.TheRestlessGhost;
 ...
 */
public class TheRestlessGhost extends QuestBase {

    public TheRestlessGhost(ClientContext ctx,Clestia clestia){
        super(27, Quests.THE_RESTLESS_GHOST,"The Restless Ghost",ctx,clestia);
    }
