package me.johngreen.clestia.Quests.FTP.VampyreSlayer;
 ...
 */
public class VampyreSlayer extends QuestBase {

    public VampyreSlayer(ClientContext ctx,Clestia clestia){
        super(132, Quests.VAMPYRE_SLAYER,"Vampyre Slayer",ctx,clestia);
    }
