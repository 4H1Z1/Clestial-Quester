 ...
 * Class created by Overflow, as seen here https://www.powerbot.org/community/topic/1239003-quest-definitions/
 */
public enum Quests {
    NONE(0, 0, 0, 0, 0),
    ...
    public final int varpbit;
    public final int upperBitIndex;
    public final int lowerBitIndex;
    private final int startValue;
    public final int completeValue;

    private Quests(int varpbit, int upperBitIndex, int lowerBitIndex, int startValue, int completeValue) {
    ...
    private Quests(int index, int startValue, int completeValue) {
    ...
    private int state(final ClientContext ctx) {
        return upperBitIndex == -1 ? ctx.varpbits.varpbit(varpbit) : ((ctx.varpbits.varpbit(varpbit) >> shift()) & mask());
    }

    public boolean started(final ClientContext ctx) {
        return state(ctx) >= startValue;
    }

    public boolean completed(final ClientContext ctx) {
        return state(ctx) >= completeValue;
    }
